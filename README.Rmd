...
Identify the top 3 most consistently differentially expressed genes between the earliest and latest time points for each combination of `plant` and `virus`.
