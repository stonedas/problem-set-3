...
joined_data %>% ggplot(aes(x = time.point, y = value, color = gene.name)) + geom_point() + facet_wrap("plant") + geom_smooth(method = "lm", se = FALSE) + theme_bw() + labs(title = "Gene expression over time") 
```
